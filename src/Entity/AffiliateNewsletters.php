...
/**
 * AffiliateNewsletters
 */
#[ORM\Table(name: 'affiliate_newsletters')]
#[ORM\Entity]
class AffiliateNewsletters
{
    /**
     * @var int
     */
    #[ORM\Column(name: 'affiliate_newsletters_id', type: 'integer', nullable: false)]
    #[ORM\Id]
    #[ORM\GeneratedValue(strategy: 'IDENTITY')]
    private $affiliateNewslettersId;
    ...
    public function getAffiliateNewslettersId(): ?int
    {
        return $this->affiliateNewslettersId;
    }
