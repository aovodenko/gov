...
/**
 * FilterProductsOptionsValuesToProductsOptions
 */
#[ORM\Table(name: 'filter_products_options_values_to_products_options')]
#[ORM\Entity]
class FilterProductsOptionsValuesToProductsOptions
{
    /**
     * @var int
     */
